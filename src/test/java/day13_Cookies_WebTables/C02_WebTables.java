...
public class C02_WebTables extends TestBase {
    ...
    public void webTable() {
        ...
        //tum satirlari ayri ayri yazdir
        List<WebElement> tumSatirlarWebElement = driver.findElements(By.xpath("//tbody//tr"));
        System.out.println("Tum satirlar : " + tumSatirlarWebElement.size());
        int satir = 1;
        for (WebElement each:tumSatirlarWebElement) {
            System.out.println(satir++ + ". satir : " + each.getText());
        }
        ...
        // satir sabit tutulup td degeri bos birakilarak o satirdaki her bir data elde edilmis oldu.
        ...
        List<WebElement> basliklarListesi=driver.findElements(By.xpath("//thead//tr[1]//th")); // basliklari bir List'e atar.
        int emailSutunNo=0;
        ...
        List<WebElement> emailSutunListesi=
                driver.findElements(By.xpath("//tbody//td["+(emailSutunNo+1)+"]")); //list index 0'dan başlar, webtable index 1'den baslar.
